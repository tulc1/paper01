...
from utils import second_order_head_tail
...
from default_config.path import default_path, default_name
from utils.two_order_head_tail import count_two_order_head_tail
...
def train(model):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.log:
            ...
            print("")
            # ===================添加到文件中=====================================
            with open(default_path() + default_name(), 'a+', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    # second_order_head_tail(data)
    # count_two_order_head_tail(data, top_bottom_items_list)
